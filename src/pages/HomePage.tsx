...
const discoveryItems = [
  {
    ...
    view: { name: 'section', section: 'journal' }
  },
  {
    id: 'random',
    title: 'random',
    text: '오래된 사진, 문장, 레이싱 메모를 우연히 다시 꺼내기.',
    view: { name: 'detail', recordId: 'gallery-first-mood' }
  },
  {
    id: 'timeline',
    title: 'timeline',
    text: '글, 사진, 세션 기록을 날짜 순서로 천천히 훑어보기.',
    view: { name: 'section', section: 'archive' }
  }
] satisfies { id: string; title: string; text: string; view: View }[];
